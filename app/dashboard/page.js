    ...
    <Layout>
      ...
      <div style={{ display: "flex", gap: "1rem", marginBottom: "2rem", flexWrap: "wrap" }}>
        ...
        <button className="btn-outline" onClick={() => {
          if (business?.id) navigator.clipboard.writeText(`${window.location.origin}/book/${business.id}`).then(() => alert("Booking link copied!"));
      ...
      <div className="card">
        ...
        {bookings.length === 0 ? (
          <div style={{ textAlign: "center", padding: "3rem 0" }}>
            ...
            <button className="btn" style={{ marginTop: "1rem" }} onClick={() => router.push("/book")}>
